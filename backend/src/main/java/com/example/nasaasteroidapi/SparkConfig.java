    ...
    public SparkSession sparkSession() {
        return SparkSession.builder()
            //  String mongoURI = "mongodb://" + mongoUsername + ":" + mongoPassword + "@localhost:27017/NASA_data.asteroids";
                ...
                .config("spark.mongodb.read.connection.uri", "mongodb://Nasa_user_name:Nasa_secret_password@mongo:27017/NASA_data.asteroids")
                .config("spark.mongodb.write.connection.uri", "mongodb://Nasa_user_name:Nasa_secret_password@mongo:27017/NASA_data.asteroids")
                .getOrCreate();
